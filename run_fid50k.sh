...
OUT_DIR=${OUT_DIR:-"$REPO_DIR/outputs/jittor-b16-256-fid50k"}
JITTOR_PY=${JITTOR_PY:-python}
TORCH_PY=${TORCH_PY:-python}
CHECKPOINT=${JIT_CHECKPOINT:-"$REPO_DIR/checkpoints/checkpoint-last.pth"}
FID_STATS=${FID_STATS:-"$REPO_DIR/fid_stats/jit_in256_stats.npz"}
